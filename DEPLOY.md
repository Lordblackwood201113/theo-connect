# Déploiement — theo-connect.locagri-app.com (Cloudflare Pages)
...
## 3. Custom domain `theo-connect.locagri-app.com` (DNS sur Hostinger)

1. Projet Pages → **Custom domains** → **Set up a custom domain** → saisir `theo-connect.locagri-app.com`.
...
5. Vérifier :
   ```bash
   dig +short theo-connect.locagri-app.com
   curl -I  https://theo-connect.locagri-app.com/
   curl -i  https://theo-connect.locagri-app.com/version.txt
   ```
