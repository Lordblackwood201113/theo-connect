// Cloudflare Worker entrypoint for the THEO COLLECT frontend.
// Proxies ODK Central paths to job-tracker.fr (same-origin, cookies rewritten)
// and falls through to the static assets bundle (env.ASSETS) for everything else.
...
export default {
  async fetch(request, env) {
    ...
    // Strip Domain= so Set-Cookie binds to the current host (collect.locagri-app.com),
